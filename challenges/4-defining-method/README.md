...
- Definir un metodo que acepte argumentos

## Resumen
Define un metodo llamado, `do_something` el cual acepte 3 argumentos.

No tienes que escribir ningun codigo dentro del cuerpo del metodo.

...
## Resumen
Crea un metodo llamado `welcome` que acepte una direccion como un simple string.

Deve devolver `"Welcome to California"` si la direccion incluye `"CA"` o `"You should move to California"` si no es asi.
